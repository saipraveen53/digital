...
import { ArrowLeft, ChevronDown, ChevronUp, Heart, HelpCircle, Leaf, ShieldCheck } from 'lucide-react-native';
...
export default function FAQPage() {
  ...
  // ✅ ANTI-DIRECTION SCROLL ANIMATION (స్క్రోల్ చేస్తుంటే బాల్స్ వ్యతిరేక దిశలో కదులుతాయి)
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#FAF9F5' }}>
      {/* ✅ IMAGE_FB9776 లో ఉన్నటువంటి MULTIPLE COLORED BALLS BACKGROUND */}
      ...
      {/* ✅ MOBILE BACK NAVIGATION BUTTON HEADER */}
      {!isDesktop && (
        <View style={styles.mobileHeader}>
          <Pressable onPress={() => router.push('/(user)/settings')} style={styles.backButton}>
            <ArrowLeft size={22} color="#11231D" />
          </Pressable>
          <Text style={styles.mobileHeaderTitle}>FAQ's</Text>
        </View>
      )}
