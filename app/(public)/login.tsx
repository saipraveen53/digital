...
export default function Login() {
  ...
  // Backend OAuth Flow Trigger Button
  const handleGoogleLogin = async () => {
    const backendAuthUrl = "https://wellbeing-fw2o.onrender.com/oauth2/authorization/google";
    if (Platform.OS === 'web') {
      window.location.href = backendAuthUrl;
    } else {
      try {
        let result = await WebBrowser.openAuthSessionAsync(backendAuthUrl, "yourapp://redirect");
        ...
        setError("Google Login failed on mobile browser setup.");
      }
    }
  };
            ...
            <View className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 w-full max-w-md">
              ...
              <View className="mb-8">
                <View className="flex-row justify-between items-center mb-2">
                  ...
                  <Pressable onPress={() => setForgotModalVisible(true)}><Text className="text-teal-600 text-sm font-medium">Forgot Password?</Text></Pressable>
                </View>
              ...
              <View className="flex-row justify-center items-center gap-1">
                ...
                <Link href="/register" asChild><Pressable><Text className="text-teal-600 font-bold">Create Account</Text></Pressable></Link>
              </View>
            </View>
          </View>
            ...
            {forgotStep === 'NEW_PASSWORD' && (
              <View>
                <View className="items-center mb-6">
                  ...
                  <Text className="text-slate-500 text-center mt-1">
                    Enter your new password for {forgotEmail}
                  </Text>
                </View>
                {forgotError ? (
                  <View className="bg-red-50 border border-red-200 rounded-xl p-3 mb-4">
                ...
                <View className="mb-6 relative">
                  ...
                  <TextInput
                    className="w-full bg-slate-50 border border-slate-200 p-4 pr-12 rounded-xl text-slate-800"
